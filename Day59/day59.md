...
![Status](https://img.shields.io/badge/Status-Day_9_Completed-success?style=for-the-badge)
![Sprint](https://img.shields.io/badge/Sprint-9%2F10-blue?style=for-the-badge)
![Release](https://img.shields.io/badge/Release-Launch_Ready-success?style=for-the-badge)
...
Gemini --> Timeout[Timeout Protection]

Timeout --> Fallback[Fallback Model]

Fallback --> Response[Structured JSON Response]
...
UploadResume --> ResumeParsing

ResumeParsing --> PasteJobDescription

PasteJobDescription --> ValidateInput

ValidateInput --> GeminiAI

GeminiAI --> GenerateATSReport

GenerateATSReport --> SaveAnalysis

SaveAnalysis --> MongoDB

MongoDB --> DashboardHistory

DashboardHistory --> DetailedResults

DetailedResults --> User
```
